...
public class Person {
    ...
    private String name;
  @Basic
    @Column(name = "also_known_as", nullable = false, length = 200)
    private String givenname;

    @Basic
    @Column(name = "Known_for_department", nullable = true, length = 80)
    private String Kown_for_department;


    @Basic
    @Column(name="place_of_birth", nullable = true, length = 80)
